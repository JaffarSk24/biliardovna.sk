...
class Coupon
{
    ...
    {
        $sql = "INSERT INTO coupons (code, discount_percent, discount_amount, valid_until, booking_id, customer_email) 
                VALUES (:code, :discount_percent, :discount_amount, :valid_until, :booking_id, :customer_email)";
